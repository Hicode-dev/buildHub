...
const Page = () => {
  ...
  return (
    <div className="grid lg:grid-cols-2 md:py-10 items-center gap-8">
         <div className="bg-slate-50 z-50 h-[50vh]  dark:bg-[#151929] py-8 shadow-lg md:hidden block relative" data-aos="fade-left">
        <div className=" ">
          <MissionCard
            className="flex items-center dark:text-white shadow-lg dark:bg-gray-800 absolute sm:right-[-30px] md:right-2 py-5 pl-4 pr-6 my-4 w-fit"
            title="Collaboration"
      ...
      <div className='mx-auto '>
        <h2 className="font-semibold text-[30px] md:text-[40px]" data-aos="fade-right">
          Helping you focus on what really matters
        </h2>
        <h2 className="leading-[28.8px] text-[20px]x1 md:w-[85%] py-4" data-aos="fade-left">
          At Buildhubb, we strive to simplify the startup journey by providing comprehensive support and resources. Our mission is to help visionary entrepreneurs like you focus on what really matters – turning your ideas into successful ventures. With our expertise, guidance, and tailored solutions, we empower you to navigate the challenges of building a business, so you can bring your vision to life and make a lasting impact in the market. Partner with Buildhubb and unlock your potential for success.
        </h2>
        <div className="grid grid-cols-2" data-aos="fade-up">
          <div className="flex gap-3 items-center">
            ...
            <span>Smooth Collaboration</span>
          </div>
          <div className="flex gap-3 items-center">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
          ...
          <div className="flex gap-3 items-center">
            ...
            <span>Experienced Leads</span>
          </div>
        </div>
      </div>
      <div className="bg-slate-50 z-50 h-[100%] dark:bg-[#151929] py-8 shadow-lg hidden md:block relative" data-aos="fade-left">
        <div className=" ">
          <MissionCard
            className="flex items-center dark:text-white shadow-lg dark:bg-gray-800 absolute sm:right-[-30px] md:right-2 py-5 pl-4 pr-6 my-4 w-fit"
            title="Collaboration"
