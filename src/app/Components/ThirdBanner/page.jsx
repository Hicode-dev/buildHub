...
const Page = () => {
  ...
  return (
    <div className="grid md:grid-cols-2 items-center gap-8">
      <div>
        <h2 className="font-semibold text-[22px] md:text-[40px]" data-aos="fade-right">
          Helping you focus on what really matters
        </h2>
        <h2 className="leading-[28.8px] text-[20px]x1 w-[85%] py-4" data-aos="fade-left">
      ...
      <div className="bg-slate-50 z-50 relative" data-aos="fade-left">
